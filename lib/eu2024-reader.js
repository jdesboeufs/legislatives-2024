...
const LISTE_COLUMNS = {
  ...
  'Nuance liste': {rename: 'nuance'},
  'Libellé abrégé de liste': {rename: 'libelleAbrege'},
  'Libellé de liste': {rename: 'libelle'},
  'Voix': {rename: 'voix', parse: parseInteger},
  '% Voix/inscrits': {rename: 'pourcentageVoixInscrits', parse: parsePercent},
  '% Voix/exprimés': {rename: 'pourcentageVoixExprimes', parse: parsePercent}
}
